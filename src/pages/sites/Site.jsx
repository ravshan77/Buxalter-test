  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
      <div className="sm:flex sm:justify-between sm:items-center mb-8">
        {/* Left: Avatars */}
         <button disabled={loading} onClick={redirectCard} className="btn bg-indigo-500 hover:bg-indigo-600 text-white ">
        ...
        <a href={`https://${currentCardData?.name}`} target={"_blank"} className="tracking-tight text-gray-900 sm:text-4xl dark:text-white underline" style={{fontSize:"26px"}}>
